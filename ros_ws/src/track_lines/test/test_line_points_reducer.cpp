...
/*
    ...
    */
    ...
    imwrite("/home/tb/gazebo_road_generation/ros_ws/src/track_lines/test/test_images/line_points_reducer/results/line_points_reducer.png",image_bird_color);

    ASSERT_EQ(false, line_points_reducer_return_info.right_line_is_reduced);
}
