...
class LineFollow
{
    ...
    void SetSearchDirectionParameters(
    float search_direction,
    ...
    vector<int> ScanIntensitiesInSearchDirection(
    int x,
    int y,
    Mat image,
    const float start_of_search,
    ...
    vector<ScannedMoments> GetScannedMoments(
    int x,
    int y,
    Mat image,
    int otsu_threshold,
    ...
    Point ChangeToBrightestCoordinateWithinReach(
    Mat image,
    ...
    void SaveCounterValuesToReturnInfo(
    const int iterations_counter,
