...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 28 13:59:52 2019
...
if __name__ == '__main__':
    ...
    face = create_cairo_font_face_for_file("/home/tb/kitcar-gazebo-generation/commonroad/renderer/fonts/DIN 1451 Std Engschrift.otf", 0)
    IMAGE_WIDTH  = 480
    IMAGE_HEIGHT = 515
    ...
    ctx.set_font_size(700)
    x = IMAGE_WIDTH/2 - 260.0
    y = IMAGE_HEIGHT/2 + 250
    ctx.move_to(x,y)
    ctx.show_text(text)
    ...
    name = "speed_limit_" + text + "_ground.png"
