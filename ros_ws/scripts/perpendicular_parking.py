...
def draw_parallel_parking_lot(context,line_width,road_width,parking_length,x_mid,PARKING_LOT_ANGLE,LINE_PADDING):
    ...
    context.move_to(x_mid, parking_length + 2*y_diff)
...
def main():
    ...
    IMAGE_WIDTH = 200 * PIXEL_PER_CM

    print("image_width",IMAGE_WIDTH)

    line_width             = cm2pixel(2)
    road_width             = cm2pixel(50)
    ...
    IMAGE_HEIGHT= int(PARKING_LOT_LENGTH * PIXEL_PER_CM + y_diff * 2)
    ...
    scenario_name = 'perpendicular_l' + str(PARKING_LOT_LENGTH) + '_a' + str(PARKING_LOT_ANGLE) + '.png'
