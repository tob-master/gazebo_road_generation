...
Als Eingabeparameter nimmt das Skript die Länge der Fahrbahn und den Offset für den Start der Mittellinienrasterung entgegen. Anschließend speichert es das Segment in einer PNG-Datei. Die breite einer der Fahrspuren beträgt in der Simulation 400mm. Die Mittel- und Außenlinien besitzen eine breite von 20mm. Die länge der Mittellinie ist mit 200mm bemessen genau wie auch deren Abstand.
...
Die Kurvensegmente besitzen die selbe Dimensionierung wie gerade Streckenabschnitte.
...
Erzeugt die Startlinie ohne Eingabeparameter.
...
Als Eingangsparameter nimmt es den Wert der Begrenzung entgegen. Anschließend speichert es das Segment in einer PNG-Datei. Auf der Fahrbahn besitzen die Markierungen eine höhe von 400mm und eine breite von 150mm.
