...
\begin{center}
  ...
  \caption[Darstellung eines geraden Streckensegments]%
           {\label{fig:GeradeSrecke}%
           Darstellung eines geraden Streckensegments}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Darstellung eines Kurvensegments]%
           {\label{fig:Kurve}%
           Darstellung eines Kurvensegments}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Darstellung eines Zielliniensegments]%
           {\label{fig:Zielliniensegment}%
           Darstellung eines Zielliniensegments}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Darstellung der Geschwindigkeitsbegrenzungssegmente]%
           {\label{fig:Geschwindigkeitsbegrenzungssegmente}%
           Darstellung der Geschwindigkeitsbegrenzungssegmente}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Darstellung eines Zebrastreifensegments]%
           {\label{fig:Zebrastreifensegment}%
           Darstellung eines Zebrastreifensegments}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Darstellung eines Kreuzungssegments]%
           {\label{fig:Kreuzungssegmente}%
           Darstellung eines Kreuzungssegments}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Darstellung der Startbox- und Parkbereichsegmente]%
           {\label{fig:SBPBSegment}%
           Darstellung der Startbox- und Parkbereichsegmente}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Darstellung der Verkehrsinselsegmente]%
           {\label{fig:Verkehrsinselsegmente}%
           Darstellung der Verkehrsinselsegmente}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Darstellung der Verkehrsschilder des Carolo-Cups]%
           {\label{fig:Verkehrsschilder}%
           Darstellung der Verkehrsschilder des Carolo-Cups}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Darstellung der Abbiegepfeilsegmente]%
           {\label{fig:Abbiegepfeil}%
           Darstellung der Abbiegepfeilsegmente}
\end{center}
\end{figure}
