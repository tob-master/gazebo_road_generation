...
\begin{center}
  ...
  \caption[Die GUI zur Anpassung der Birdseye-Transformation]%
           {\label{fig:GUI zur Anpassung der Birdseye-Transformation}%
           Die GUI zur Anpassung der Birdseye-Transformation}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Das zu suchende Fahrbahnmuster des Start-Of-Lines-Search -Algorithmus]%
...
\begin{center}
  ...
  \caption[Programmablaufplan des Start-of-Lines-Search-Algorithmus Teil 1]%
           {\label{fig:sof1}%
...
\begin{center}
  ...
  \caption[Programmablaufplan des Start-of-Lines-Search-Algorithmus Teil 2]%
           {\label{fig:sof2}%
...
\begin{center}
  ...
  \caption[ Darstellung des Bildbereichs nach Anwendung des Canny-Edge-Verfahrens]%
...
\begin{center}
  ...
  \caption[Die Bildbereichstransformation des Hough-Lines-Algorithmus]%
           {\label{fig:HoughRaum}%
           Die Bildbereichstransformation des Hough-Lines-Algorithmus}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Veranschaulichung der Hough-Linien-Suche mit dem errechneten Vanishing-Point und dessen Winkel]%
...
\begin{center}
  ...
  \caption[Programmablaufplan des Vanishing-Point-Algorithmus Teil 1]%
           {\label{fig:vp1}%
...
\begin{center}
  ...
  \caption[Programmablaufplan des Vanishing-Point-Algorithmus Teil 2]%
           {\label{fig:vp2}%
...
\begin{center}
  ...
  \caption[Darstellung der Linienabsuche des Line-Follower-Algorithmus]%
...
\begin{center}
  ...
  \caption[Visualisierung der gefundenen Linienpunkte des Line-Follower-Algorithmus]%
           {\label{fig:LPLF}%
...
\begin{center}
  ...
  \caption[Veranschaulichung des Douglas-Peucker-Algorithmus]%
...
\begin{center}
  ...
  \caption[Darstellung der reduzierten Linienpunkte nach der Anwendung des Douglas-Peucker-Algorithmus]%
           {\label{fig:RDPAlgorihtmusBild}%
           Darstellung der reduzierten Linienpunkte nach der Anwendung des Douglas-Peucker-Algorithmus}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption[Visualisierung der Rasterisierung durch die Mittelliniensuche]%
...
\begin{center}
  ...
  \caption[Visualisierung von verbundenen Mittellinien durch die Graphenerzeugung]%
...
\begin{center}
  ...
  \caption[Programmablaufplan des Mid-Line-Search-Algorithmus Teil 1]%
...
\begin{center}
  ...
  \caption[Programmablaufplan des Mid-Line-Search-Algorithmus Teil 2]%
...
\begin{center}
  ...
  \caption[Programmablaufplan des Mid-Line-Search-Algorithmus Teil 3]%
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=1\textwidth]{/home/tb/gazebo_road_generation/02_Arbeit_Latex/007_Kapitel6/Bilder/Line_Validation_Table_finish1}% keine extention: wählt jpg für DVI
  \caption[Programmablaufplan des Line-Validation-Table-Creator-Algorithmus Teil 1]%
           {\label{fig:lvtc1}%
           Programmablaufplan des Line-Validation-Table-Creator-Algorithmus Teil 1.
           }
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=1\textwidth]{/home/tb/gazebo_road_generation/02_Arbeit_Latex/007_Kapitel6/Bilder/Line_Validation_Table_finish2}% keine extention: wählt jpg für DVI
  \caption[Programmablaufplan des Line-Validation-Table-Creator-Algorithmus Teil 2]%
           {\label{fig:lvtc2}%
           Programmablaufplan des Line-Validation-Table-Creator-Algorithmus Teil 2.
           }
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=1\textwidth]{/home/tb/gazebo_road_generation/02_Arbeit_Latex/007_Kapitel6/Bilder/Line_Validation_Table_finish3}% keine extention: wählt jpg für DVI
  \caption[Programmablaufplan des Line-Validation-Table-Creator-Algorithmus Teil 3]%
           {\label{fig:lvtc3}%
           Programmablaufplan des Line-Validation-Table-Creator-Algorithmus Teil 3.
           }
\end{center}
\end{figure}
...
Mit der Funktion GetDrivePointsInDriveDirection können aus der Line-Validation-Table-Creator-Klasse Punkte extrahiert werden, welche in Fahrtrichtung verlaufen. Abzweigungen wie sie bei Kreuzungen entstehen werden nicht ber{\"u}cksichtigt.
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=0.5\textwidth]{/home/tb/Desktop/Master/Bilder/indrivedir}% keine extention: wählt jpg für DVI
  \caption[Visualisierung der Linienpunkte in Fahrtrichtung]%
...
Die Berechnung dient nur zur kompakten Beschreibung der Bereichssicherheit in einer maximal zehnstelligen großen Zahl, damit sie als einzelner Wert an Funktionen {\"u}bergeben und einfach interpretiert werden kann. Dieser Wert beschreibt die Sicherheit der Punkte im ersten Rechteck. In der 
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=0.5\textwidth]{/home/tb/Desktop/Master/Bilder/safetytrack2}% keine extention: wählt jpg für DVI
  \caption[Visiualisierung der mit Sicherheitsscores bewerteten Fahrbahnbereiche]%
           {\label{fig:RectSafety}%
           Bewertete Bereichssicherheiten dargestellt als grüne Rechtecke.
           Die als grüne Zahl dargestellte Sicherheitsbewertung gibt die Anzahl von dezimalstellen der Bewertung im Bereich an.
           }
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=0.5\textwidth]{/home/tb/Desktop/Master/Bilder/safetytrack}% keine extention: wählt jpg für DVI
  \caption[Visualisierung der Bereichssicherheitsscore über die Kreuzung hinaus]%
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=0.6\textwidth]{/home/tb/gazebo_road_generation/02_Arbeit_Latex/007_Kapitel6/Bilder/safety_rect_finish1}% keine extention: wählt jpg für DVI
  \caption[Programmablaufplan des Safe-Drive-Area-Evaluator-Algorithmus]%
           {\label{fig:sdae1}%
           Programmablaufplan des Safe-Drive-Area-Evaluator-Algorithmus.
           }
\end{center}
\end{figure}
