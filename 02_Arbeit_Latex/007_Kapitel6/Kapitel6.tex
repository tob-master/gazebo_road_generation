...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=2\textwidth]{/home/tb/gazebo_road_generation/02_Arbeit_Latex/007_Kapitel6/Bilder/vp1}% keine extention: wählt jpg für DVI
  \caption[vp1]%
           {\label{fig:vp1}%
           vp1}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=1\textwidth]{/home/tb/gazebo_road_generation/02_Arbeit_Latex/007_Kapitel6/Bilder/vp2}% keine extention: wählt jpg für DVI
  \caption[vp2]%
           {\label{fig:vp2}%
           vp2}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=1\textwidth]{/home/tb/gazebo_road_generation/02_Arbeit_Latex/007_Kapitel6/Bilder/vp3}% keine extention: wählt jpg für DVI
  \caption[vp3]%
           {\label{fig:vp3}%
           vp3}
\end{center}
