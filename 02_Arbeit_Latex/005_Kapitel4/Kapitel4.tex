...
Um die beste Auswahl einer Simulationsumgebung f{\"u}r das Carolo-Cup-Team zu treffen, wurde eine Nutzwertanalyse der m{\"o}glichen Simulationsumgebungen erstellt. 
...
\begin{center}
  ...
  \caption[Die Auswertung der Nutzwertanalyse von verschiedenen Simulationsumgebungen]%
           {\label{fig:NutzwertAnalyseSIM}%
           Die Auswertung der Nutzwertanalyse von verschiedenen Simulationsumgebungen.}
\end{center}
\end{figure}
