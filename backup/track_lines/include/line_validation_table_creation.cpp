...
int LineValidationTableCreation::GetPixelValue(int x, int y)
{
    return (int)current_image_.at<uchar>(Point(x,y));
}

int LineValidationTableCreation::GetPixelValue(Point point)
{
    return (int)current_image_.at<uchar>(point);
}


SearchLineDistanceThresholds LineValidationTableCreation::GetSearchLineDistanceThresholds(int SEARCH_LINE_CODE)
{
...
int LineValidationTableCreation::GetMinPixelIntensityThreshold(int SEARCH_LINE_CODE)
{
...
void LineValidationTableCreation::SearchOrthogonalValues(int point_in_search_direction_x,
...
SearchLineWidthThresholds LineValidationTableCreation::GetSearchLineWidthThresholds(int SEARCH_LINE_CODE)
{
...
bool LineValidationTableCreation::CheckLineMatch(vector<int> orthogonal_line_activations, SegmentStartIDAndWidth& line_match, int SEARCH_LINE_CODE)
{
...
void LineValidationTableCreation::SetOuterLineDirections(vector<PointInDirection> line_directions, int SEARCH_LINE_CODE)
{
...
bool LineValidationTableCreation::AdjacentValidationTableIsEmpty(int SEARCH_LINE_CODE)
{
...
void LineValidationTableCreation::FindMinDistanceFromPredictionToAdjacentPoint(int SEARCH_LINE_CODE,
...
void LineValidationTableCreation::ExamineValidationTable(int SEARCH_LINE_CODE, vector<LineValidationTable>&table)
{
...
void LineValidationTableCreation::ExtractDirectionsInRange(vector<LineValidationTable>& line_validation_table, vector<LineValidationTable>& line_direction_in_range )
{
...
void LineValidationTableCreation::ExtractMinMaxLineElements( vector<LineValidationTable>  line,  MinMaxLineElements& line_minmax_elements )
{
...
void LineValidationTableCreation::ExtractLastMatchingPoints(vector<LineValidationTable> line_validation_table_,
...
void LineValidationTableCreation::ExtractValidPoints()
{
...
void LineValidationTableCreation::CoutRectSafetyTables()
{
...
void LineValidationTableCreation::DrawSafetyRects(Mat& rgb_spline)
{
/*
                                                            LSCORE,
                                                             MSCORE,
...
void LineValidationTableCreation::ValidateTrack(Mat &rgb)
{
...
vector<float> LineValidationTableCreation::GetUniqueDirectionsInRect(vector<LineValidationTable> table, vector<int> rect_ids, vector<vector<int>> priority_ids, int priority)
{
...
void LineValidationTableCreation::SearchValidPoints()
{
...
void LineValidationTableCreation::DrawDirectionInRangeTable(Mat &rgb)
{
...
void LineValidationTableCreation::GatherLineValidationTables(vector<LineValidationTable> &left_line_validation_table, vector<LineValidationTable> &mid_line_validation_table, vector<LineValidationTable>& right_line_validation_table)
{
...
void LineValidationTableCreation::CreateValidationTables()
{
...
void LineValidationTableCreation::ClearValidationTables()
{
...
void LineValidationTableCreation::SafeLinePoint(SegmentStartIDAndWidth line_match, vector<Point> orthogonal_line_points, bool is_matched,
